...
var Nest = function Nest(_ref) {
  var children = _ref.children,
      ...
      props = (0, _objectWithoutProperties2.default)(_ref, ["children", "className", "error", "errorMessage", "fields", "itemProps", "label", "name", "showInlineError"]);
  return _react.default.createElement("div", (0, _extends2.default)({
    className: (0, _classnames.default)(className, {
      'has-error': error
    })
  }, (0, _filterDOMProps.default)(props)), label && _react.default.createElement("label", null, label), !!(error && showInlineError) && _react.default.createElement("span", {
